...
public class BubbleCityWithThreeWayIntersection extends AbstractTile {
	...
	public List<AbstractTileObject> buildObjectList() {
		...
		objects.add(new Farm(temp, new Point(TILE_WIDTH / 2, TILE_HEIGHT / 4), Arrays.asList(city1)));
	...
	public static TileFactory getFactory() {
		return new TileFactory(new BubbleCityWithThreeWayIntersection());
	}
