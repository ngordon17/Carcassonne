...
public class BubbleCityWithStraightRoad extends AbstractTile {
	...
	public List<AbstractTileObject> buildObjectList() {
		...
		objects.add(new Farm(temp, new Point(TILE_WIDTH / 2, TILE_HEIGHT / 3), Arrays.asList(city1)));
		...
		objects.add(new Farm(temp, new Point(TILE_WIDTH / 2, TILE_HEIGHT * 7 /8), new ArrayList<City>()));
	...
	public static TileFactory getFactory() {
		return new TileFactory(new BubbleCityWithStraightRoad());
	}
}
