...
public class BubbleCityWithCurvedRoadTwo extends AbstractTile {
	...
	public List<AbstractTileObject> buildObjectList() {
		...
		objects.add(new Farm(temp, new Point(TILE_WIDTH / 3, TILE_HEIGHT * 2 / 3), Arrays.asList(city1)));
	...
	public static TileFactory getFactory() {
		return new TileFactory(new BubbleCityWithCurvedRoadTwo());
	}
}