...
public class BridgeCityWithShield extends AbstractTile {
	...
	public List<AbstractTileObject> buildObjectList() {
		...
		City city1 = new City(temp, new Point(TILE_WIDTH / 2, TILE_HEIGHT / 2), true);
		objects.add(city1);
	...
	public static TileFactory getFactory() {
		return new TileFactory(new BridgeCityWithShield());
	}
}